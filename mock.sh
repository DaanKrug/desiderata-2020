...
<?php
    ...
    $mockDir = "/var/www/html/desiderata_mock";
	...
	shell_exec('sudo cp -r ' . $staticFilesDir . '/headers ' . $mockDir);
    ...
    echo("\nMockado. Acesse o endereço: 'http://localhost/desiderata_mock' em seu navegador\n\n");
